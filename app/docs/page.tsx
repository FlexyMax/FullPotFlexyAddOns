...
const endpoints: Endpoint[] = [
  ...
  },
  {
    ...
    bodyParams: [
      ...
      { name: "qty_confirm",         type: "integer",     required: true,  description: "Qty confirmed" },
      ...
      { name: "po_price",            type: "decimal",     required: true,  description: "PO unit price" },
      ...
      { name: "ship_date",           type: "date",        required: true,  description: "Vendor ship date (YYYY-MM-DD)" },
      { name: "food",                type: "boolean",     required: true,  description: "Flower food flag" },
      { name: "pccode",              type: "string(20)",  required: true,  description: "Vendor item code" },
      { name: "details",             type: "string(250)", required: true,  description: "PO notes / instructions" },
      ...
      { name: "wphysical_uq",        type: "string(8)",   required: true,  description: "Warehouse ID" },
    ...
    response: `{ unico: string, message: string, error: boolean }`,
    example: {
      request: `PUT /api/purchase-orders/C9D0E1F2

{
  ...
  "pickup_order": false
      ...
      response: `{ "unico": "C9D0E1F2", "message": "Purchase order updated successfully", "error": false }`,
    },
  },
  {
    method: "GET",
  ...
  "data": [
    {
      ...
      "sorder_no": 0,
      "cporder_no": "FP#998",
      "customer": "EAST END FLOWERS SHOP - 998 / DANIEL",
      "description": "ANTHURIUM  OBAKE  BICOLOR",
      "case_sh": "QB",
      "case_uq": "BB58F6B1",
      "qty_order": 1,
      "qty_bunches": 40,
      ...
      "pb_date": "2026-06-16",
      "agency": "",
      "warehouse": "MIAMI PRE ORDERS - MIAMI",
      "wphysical_uq": "BUEB4005",
      "pbook_d_uq": "F47DF023",
      "pbook_uq": "0FCC1E01",
      "funit_price": 0.0,
      "invoiced_cases": 0.0,
      "favorite_farms": "AIRSEATRANS / EZ FLOWER / ACURA",
      "customer_ship_date": "2026-06-16"
    }
  ],
  "count": 1
}`,
